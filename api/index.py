    ...
    if _llm is not None:
        try:
            prompt = (
                ...
                "หากผู้ใช้ถามหาสิ่งที่ 'ในฐานข้อมูล' หรือระบบไม่มีข้อมูลจำเพาะเจาะจง ให้คุณใช้ความรู้ทั่วไปของคุณตอบไปเลย ห้ามตอบว่า 'ไม่ทราบ' 'ไม่มีข้อมูล' หรือ 'ไม่อยู่ในฐานข้อมูล' เด็ดขาด\n\n"
                f"คำถาม: {question}"
            )
